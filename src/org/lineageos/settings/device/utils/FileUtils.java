...
public final class FileUtils {
    ...
    /**
     * Reads a file and returns the value as a boolean
     *
     * @param filename the file to read
     * @param defValue the default value if file doesn't exist or read fails
     * @return false if value is "0", true otherwise; defValue on failure
     */
    ...
    /**
     * Reads a file and returns the value as a string
     *
     * @param filename the file to read
     * @param defValue the default value if file doesn't exist or read fails
     * @return the file content as string, or defValue on failure
     */
